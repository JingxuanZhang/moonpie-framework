...
class Create extends Migrate
{
    ...
    {
        $this->setName('mp:plugin-migrate-create')
             ->setDescription('Create a new plugin migration for some version')
             ->addArgument('name', InputArgument::REQUIRED, 'What is the name of the migration?')
             ->setHelp(sprintf('%sCreates a new plugin database migration%s', PHP_EOL, PHP_EOL));
    }
