...
class Console extends BaseConsole
{
    ...
    protected function getDefaultCommands()
    {
        ...
        foreach (static::$defaultCommands as $class) {
    ...
    {
        static::$defaultCommands = array_merge(static::$defaultCommands, $classes);
    }
